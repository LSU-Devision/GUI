...
class SettingsWindow(tk.Toplevel):
    ...
    def __init__(self, master=None,container=None,settings=None):
        ...
        def create_page():
            ...
            self.automatic_prediction_data_clear = ttk.Button(self,text='Automatic Prediction Data Clear',command=toggle_automatic_prediction_data_clear)
            ...
            self.clear_data_on_clear_images_button = ttk.Button(self, text='Clear Data on Clear Images',command=toggle_clear_data_on_clear_images)
            ...
            self.save_images_output_button = ttk.Button(self, text='Save images to Output',command=toggle_save_images_output)
            # create the reset settings button
            self.default_settings_button = ttk.Button(self, text='Reset To Default Settings',command=reset_settings)
